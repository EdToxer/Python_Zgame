...
class Game:
    def __init__(self):
        ...
        pygame.display.set_caption("Z World")
        ...
        #enemy
        self.zombie_cooldown = 20000
        self.zombie_time = 0
        self.can_zombie = True
        self.spawn_position = []
    ...
    def bullet_collision(self):
        if self.bullet_sprites:
            for bullet in self.bullet_sprites:
                hit_enemy = pygame.sprite.spritecollide(bullet, self.enemy_sprites, False, pygame.sprite.collide_mask)
                if hit_enemy:
